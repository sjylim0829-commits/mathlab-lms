  ...
  getActivities() {
    const defaultList = [
      ...
      },
      {
        ...
        grade: '2학년 전체 (1~8반)',
        url: 'https://script.google.com/macros/s/AKfycbxYqJDjYAmxHEtDoYOWqjzwan9ZkMfw3JXmutd2GkebFRKHfANAe2wyIkipKDUvvmkI/exec',
        desc: 'Redbook 제작: 세 내각의 이등분선 작도, 내심 I 및 내접원(r), 세 변까지의 거리(ID=IE=IF) & 각도 성질(∠BIC = 90° + ½∠A) 증명 웹 앱 (LMS DB 연동 완료)',
        type: 'gas'
      }
    ];
